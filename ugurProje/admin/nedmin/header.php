...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a style="background-color: #00000000;" href="index.php" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>E</b>OTO</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Evren</b>Oto</span>
    </a>

    <!-- Header Navbar -->
    <nav style="background-color: #00000000;" class="navbar navbar-static-top" role="navigation">
