...
<head>
  ...
  <title>Evren Otomotiv CMS</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="" style="color: white;"><b>Evren</b>OTO</a>
  </div>
  <!-- /.login-logo -->
...
<?php 
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="admins_login" class="btn btn-primary btn-block btn-flat" style="background-color:gold;color:black;">Giriş Yap</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
